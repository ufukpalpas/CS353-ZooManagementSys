		...
		<main>
            ...
            <section class="mainsec">
				...
				echo "<tr class=\"toptable\">
						<th>Cage ID<hr></th>    
						<th>Cage Type<hr></th>    
						<th>Animal Count<hr></th>    
						<th>Last Care Date<hr></th>   
						<th>Feed Time<hr></th>  
						<th>Location<hr></th>  
						<th>Food<hr></th>   
						<th>Select for any operation<hr></th>   
					</tr>";
				if($result = $mysqli->query($query)){
					while(($row = $result->fetch_assoc())!= null)  {
						echo "<tr>
								...
								<th><form method=\"post\"><input type=\"submit\" class=\"btn3\" value=\"Regularize Food\"></form><hr></th>  
								<th><form method=\"post\"><input type=\"submit\" class=\"btn3\" value=\"Select\"></form><hr></th>  
							</tr>";
					}
				} else {

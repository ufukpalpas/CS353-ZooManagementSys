    ...
    if($result = $mysqli->query($query)) {
		if($result->num_rows == 1){
			...
			if($result1->num_rows == 1){ //keeper
				...
				$name = $fetcharr['name'];
				$_SESSION['name'] = $name;
				header("location: educationin.php");
	...
	<body>
		...
		<div class="login-popup" id="login-popup">
            ...
            <section class="mainsec">
				...
				<div class="picdiv">
					<img class="mainpic" src="image/vet.jpg" alt="zoo tour foto">
				</div>
                <article>
                    <h3>Educational programs in KasaloZoo!</h3>
                    <p>
                        Educational programs are being conducted for the veterinerians. <br>
